...
function UsingView:initView()
    ...
    --底图
    local basemapGuide = display.newSprite("artcontent/lobby_ongame/atlas_interface/basemap_guide.png")
    ...
    --底图
    local basemap = display.newSprite("artcontent/lobby_ongame/atlas_interface/tower_use/basemap_replacetower.png")
    self.container_2:addChild(basemap)
    basemap:setAnchorPoint(0.5, 1)
    basemap:setPosition(display.cx,height)

    tempfilename="artcontent/lobby_ongame/currency/icon_tower/%02d.png"
    ...
    --等级底图
    tempfilename="artcontent/lobby_ongame/atlas_interface/current_lineup/basemap_grade.png"
    ...
    --取消按钮
    local cancelbtn= ccui.Button:create("artcontent/lobby_ongame/atlas_interface/tower_use/icon_cancel.png")
