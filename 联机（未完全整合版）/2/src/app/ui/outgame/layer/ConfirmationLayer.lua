...
function ConfirmationLayer:initView()
    ...
    local sprite1 = display.newSprite("artcontent/lobby_ongame/currency/chestopen_confirmationpopup/basemap_popup.png")
    ...
    --确认按钮
    tempfileneme="artcontent/lobby_ongame/currency/chestopen_confirmationpopup/button_confirm.png"
    ...
    --金币
    local gold= display.newSprite("artcontent/lobby_ongame/currency/chestopen_confirmationpopup/icon_gold.png")
    ...
    --获得的塔和数目
    local towerfileneme ="artcontent/lobby_ongame/currency/chestopen_confirmationpopup/icon_tower/%d.png"
