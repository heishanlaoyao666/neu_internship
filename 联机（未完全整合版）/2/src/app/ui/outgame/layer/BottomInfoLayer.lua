...
function BottomInfoLayer:initView()
    ...
    local unLeftImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/tab_unchecked_left.png")
    ...
    local unMediumImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/tab_unchecked_medium.png")
    ...
    local unRightImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/tab_unchecked_right.png")
    ...
    local selectedImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/tab_currently_selected.png")
    ...
    local iconAtlasImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/icon_atlas.png")
    ...
    local titleAtlasImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/title_atlas.png")
    ...
    local iconBattleImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/icon_battle.png")
    ...
    local titleBattleImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/title_battle.png")
    ...
    local iconStoreImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/icon_store.png")
    ...
    local titleStoreImg = ccui.ImageView:create("artcontent/lobby_ongame/bottombar_tabbutton/title_store.png")
