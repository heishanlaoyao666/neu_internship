...
function BossChooseView:initView()
    --底图
    local popUpSprite = cc.Sprite:create("artcontent/battle(ongame)/randomboss_popup/basemap_popup.png")
    popUpSprite:setScale(1.2, 0.8)
    popUpSprite:setPosition(display.cx, display.cy)
    popUpSprite:addTo(self)

    --选框
    local selectSprite = cc.Sprite:create("artcontent/battle(ongame)/randomboss_popup/basemap_selectboss.png")
    selectSprite:setScale(0.8)
    selectSprite:setPosition(display.cx, display.cy)
    selectSprite:addTo(self)

    --宝石箭头
    local arrowSprite = cc.Sprite:create("artcontent/battle(ongame)/randomboss_popup/arrow_gem.png")
