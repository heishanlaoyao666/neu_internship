...
function FightingInfoLayer:updatePoint()
    ...
    elseif myPoint <= 0 then
        myPoint_[1]:loadTexture("artcontent/battle(ongame)/battle_interface/hp_empty.png")
    ...
    elseif enemyPoint <= 0 then
        enemyPoint_[1]:loadTexture("artcontent/battle(ongame)/battle_interface/hp_empty.png")
