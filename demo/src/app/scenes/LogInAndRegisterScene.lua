...
local LoginErrDialog = require("app.ui.layer.logInAndRegister.dialog.LoginErrDialog")
local RegisterSucceedDialog = require("app.ui.layer.logInAndRegister.dialog.RegisterSucceedDialog")
