...
local LoginErrDialog = class("LoginErrDialog", require("app.ui.layer.BaseUILayout"))
...
function LoginErrDialog:ctor(text)
    LoginErrDialog.super.ctor(self)
...
function LoginErrDialog:initView()
    print("init dialog")
