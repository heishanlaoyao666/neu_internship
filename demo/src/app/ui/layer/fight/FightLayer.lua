...
function FightLayer:onExit()
    EventManager:unRegListener(EventDef.ID.ENEMY_CREATE, self)
    ...
    EventManager:unRegListener(EventDef.ID.BOSS_CREATE, self)
    EventManager:unRegListener(EventDef.ID.BOSS_DEATH, self)
