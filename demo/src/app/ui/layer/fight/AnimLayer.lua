...
function AnimLayer:onExit()
    print("anim on exit")
    EventManager:unRegListener(EventDef.ID.CARD_BEGAN_DRAG, self)
    EventManager:unRegListener(EventDef.ID.CARD_MOVED_DRAG, self)
    EventManager:unRegListener(EventDef.ID.CARD_ENDED_DRAG, self)
end
