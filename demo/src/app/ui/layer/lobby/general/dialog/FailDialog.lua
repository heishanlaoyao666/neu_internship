...
local FailDialog = class("FailDialog", require("app.ui.layer.BaseLayer"))
...
function FailDialog:ctor(code)
    FailDialog.super.ctor(self)
...
function FailDialog:initParam(code)
    self.listener_ = nil
    self.isListening_ = false -- 是否监听
    self.text_ = nil

    if code == ConstDef.FAIL_CODE.PURCHASE_GOLD_DEFICIENCY then
        self.text_ = "image/lobby/general/inform/purchase_fail_gold_text.png"
    elseif code == ConstDef.FAIL_CODE.PURCHASE_DIAMOND_DEFICIENCY then
        self.text_ = "image/lobby/general/inform/purchase_fail_diamond_text.png"
    elseif code == ConstDef.FAIL_CODE.UPGRADE_GOLD_DEFICIENCY then
        self.text_ = "image/lobby/general/inform/upgrade_fail_gold_text.png"
    elseif code == ConstDef.FAIL_CODE.UPGRADE_CARD_DEFICIENCY then
        self.text_ = "image/lobby/general/inform/upgrade_fail_card_text.png"
    end
end
...
function FailDialog:initView()
    ...
    -- 说明文字
    local introText = ccui.ImageView:create(self.text_)
