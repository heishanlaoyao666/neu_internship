...
function Tower:ctor(towerId, towerRarity, towerType, towerName, towerInfo,
    ...
    towerSkill1, towerSkill1Num,skill1Value, valueUpgrade, valueEnhance,
    towerSkill2,towerSkill2Num, skill2Value)
...
--[[--
    ...
    @paem 类型：number，level

    @return number
]]
function Tower:setLevel(level)
    self.level_ = level
end
