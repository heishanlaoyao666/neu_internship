...
function MyFightingLayer:myInitView()
    ...
    for i = 1, #self.lineup_ do
        --头像
        local spriteRes = "artcontent/battle_ongame/battle_interface/tower/tower_%d.png"
        ...
        --强化sp底图
        local spSprite = cc.Sprite:create("artcontent/battle_ongame/battle_interface/basemap_sp.png")
    ...
    --生成塔按钮
    local buildBtn = ccui.Button:create("artcontent/battle_ongame/battle_interface/button_generate.png")
...
function MyFightingLayer:onTouchEnded(x, y, tower1)
    ...
    if tower1:getStar() >= 7 or tower2 == nil or tower1:getStar() ~= tower2:getStar() then
        ...
        GameData:merging(tower1, tower2, 1)
        if cc.UserDefault:getInstance():getBoolForKey("音效") then
...
function MyFightingLayer:onEnter()
    ...
    EventManager:regListener(EventDef.ID.CREATE_SELF, self, function(tower)
        ...
        --角标
        spriteRes = "artcontent/battle_ongame/battle_interface/anglemark_grade/%d.png"
    ...
    EventManager:regListener(EventDef.ID.CREATE_MONSTER, self, function(monster)
        local sprite = "artcontent/battle_ongame/battle_interface/littlemmonster.png"
    ...
    EventManager:regListener(EventDef.ID.CREATE_ELITE_MONSTER, self, function(eliteMonster)
        local sprite = "artcontent/battle_ongame/battle_interface/elitemonster.png"
    ...
    EventManager:regListener(EventDef.ID.CREATE_BULLET, self, function(bullet)
        local spriteRes = "artcontent/battle_ongame/battle_interface/bullet/%d.png"
    ...
    EventManager:regListener(EventDef.ID.UPDATE_STAR, self, function(tower)
        local spriteRes = "artcontent/battle_ongame/battle_interface/anglemark_grade/%d.png"
