...
function AdmitDefeatView:initView()
    --认输界面
    self.adSprite_ = cc.Sprite:create("artcontent/battle_ongame/admitdefeat_confirmationpopup/basemap_popup.png")
    ...
    --确定认输按钮
    self.okBtn_ = ccui.Button:create("artcontent/battle_ongame/admitdefeat_confirmationpopup/button_ok.png")
    ...
    --取消认输按钮
    self.cancelBtn_ = ccui.Button:create("artcontent/battle_ongame/admitdefeat_confirmationpopup/button_cancel.png")
