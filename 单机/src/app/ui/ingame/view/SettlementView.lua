...
function SettlementView:initView()
    ...
    --敌方标志
    local enemyMatk = cc.Sprite:create("artcontent/battle_ongame/battle_interface/oppositemark.png")
    enemyMatk:setPosition(100, display.cy - 400)
    enemyMatk:setScale(0.8 * 1.2, 1 * 1.2)
    enemyMatk:addTo(enemySprite)

    --敌方名字底图
    local enemyNameSprite = cc.Sprite:create("artcontent/battle_ongame/settlement_interface/basemap_text.png")
    ...
    --敌方奖杯
    local enemyTrophySprite = cc.Sprite:create("artcontent/battle_ongame/settlement_interface/icon_trophy.png")
    ...
    --敌方奖杯数底图
    local enemyTrophyNumSprite = cc.Sprite:create("artcontent/battle_ongame/settlement_interface/basemap_text.png")
