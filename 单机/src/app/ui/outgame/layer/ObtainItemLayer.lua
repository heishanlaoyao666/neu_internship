...
function ObtainItemLayer:initView()
    ...
    --底图
    local sprite1 = display.newSprite("artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/basemap_popup.png")
    ...
    --x按钮
    local offBtn= ccui.Button:create("artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/button_off.png")
    ...
    local onBtn= ccui.Button:create("artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/button_on.png")
    ...
    --金币底图
    tempfilename="artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/basemap_gold.png"
    ...
    --金币图标
    local iconGold= display.newSprite("artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/icon_gold.png")
    ...
    --图标和文本
    --碎片类型和文本
    local normal= display.newSprite("artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/icon_normal.png")
    ...
    textfilename="artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/basemap_text.png"
    ...
    local rare= display.newSprite("artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/icon_rare.png")
    ...
    local epic= display.newSprite("artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/icon_epic.png")
    ...
    if self.num4~=nil then
        tempfilename="artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/icon_legend.png"
    ...
    --宝箱图片
    tempfilename="artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/"..self.filename
    ...
    --宝箱类型
    tempfilename="artcontent/lobby_ongame/currency/chestopen_ obtainitemspopup/"..self.chesttitle
