...
function TowerLayer:initView()
    ...
    tempfilename="artcontent/lobby_ongame/atlas_interface/tower_detailpopup/basemap_tower_normal.png"
    local normal = display.newSprite(tempfilename)

    tempfilename=string.format("artcontent/lobby_ongame/currency/icon_tower/%02d.png",id)
    ...
    grade = display.newSprite(string.format("artcontent/lobby_ongame/atlas_interface/tower_list/grade/Lv.%d.png",
    ...
    local towerBasemap = display.newSprite("artcontent/lobby_ongame/atlas_interface/tower_detailpopup/"
