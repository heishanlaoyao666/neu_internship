...
function BuyLayer:initView()
    ...
    --底图
    local basemap = display.newSprite("artcontent/lobby_ongame/store/goldstore_confirmationpopup/basemap_popup.png")
    ...
    --x按钮
    local offBtn= ccui.Button:create("artcontent/lobby_ongame/store/goldstore_confirmationpopup/button_off.png")
    ...
    --金币购买确认按钮
    local purchase= ccui.Button:create("artcontent/lobby_ongame/store/goldstore_confirmationpopup/button_purchase.png")
    ...
    local gold= ccui.Button:create("artcontent/lobby_ongame/store/goldstore_confirmationpopup/icon_goldcoin.png")
    ...
    --商品图片显示
    local tower = display.newSprite("artcontent/lobby_ongame/store/goldstore/itemicon_tower/"..self.id..".png")
    tower:addTo(basemap)
    tower:setScale(0.8)
