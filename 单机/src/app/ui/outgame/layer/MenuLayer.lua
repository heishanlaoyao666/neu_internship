...
function MenuLayer:initView()
    ...
    local basemap = display.newSprite("artcontent/lobby_ongame/topbar_playerinformation/menu_bar/basemap_menu.png")
    ...
    --四个按钮，从下往上
    tempfilename="artcontent/lobby_ongame/topbar_playerinformation/menu_bar/basemap_button.png"
    ...
    --设置
    local setSprite = display.newSprite("artcontent/lobby_ongame/topbar_playerinformation/menu_bar/icon_sett.png")
    ...
    local fontSet = display.newSprite("artcontent/lobby_ongame/topbar_playerinformation/menu_bar/font_settings.png")
    ...
    --对战记录
    tempfilename="artcontent/lobby_ongame/topbar_playerinformation/menu_bar/icon_battlerecord.png"
    ...
    tempfilename="artcontent/lobby_ongame/topbar_playerinformation/menu_bar/text_battlerecord.png"
    ...
    --邮箱
    local mailbox = display. newSprite("artcontent/lobby_ongame/topbar_playerinformation/menu_bar/icon_mailbox.png")
    ...
    local textMailbox= display.newSprite("artcontent/lobby_ongame/topbar_playerinformation/menu_bar/text_mailbox.png")
    ...
    --公告
    tempfilename="artcontent/lobby_ongame/topbar_playerinformation/menu_bar/icon_announcement.png"
    ...
    tempfilename="artcontent/lobby_ongame/topbar_playerinformation/menu_bar/font_announcements.png"
