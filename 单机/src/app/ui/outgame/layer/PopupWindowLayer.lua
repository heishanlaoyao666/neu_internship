...
function PopupWindowLayer:initView()
    ...
    local basemap = display.newSprite("artcontent/lobby_ongame/currency/notice_popup/basemap_popup.png")
    ...
    --确认按钮
    local okBtn= ccui.Button:create("artcontent/lobby_ongame/currency/notice_popup/button_ok.png")
    ...
    --文字提示
    local text= display.newSprite("artcontent/lobby_ongame/currency/notice_popup/text_"..self.index..".png")
