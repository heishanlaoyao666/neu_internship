...
local DiamondGroupYouSiJiao = class("DiamondGroupYouSiJiao ",require("src.app.data.Object"))
...
function DiamondGroupYouSiJiao :ctor(x,y,color)
    DiamondGroupYouSiJiao .super.ctor(self, x, y, color)
    self.size_ = ConstDef.DIAMOND_GROUP_SIZE.YOUSiDiamondGroupYouSiJiaoJIAO
    self:init()
end
...
function DiamondGroupYouSiJiao :canRotateToSouth()
...
function DiamondGroupYouSiJiao :canRotateToWest()
...
function DiamondGroupYouSiJiao :canRotateToNorth()
...
function DiamondGroupYouSiJiao :canRotateToEast()
...
function DiamondGroupYouSiJiao:init()
    local diamond_1 = Diamond.new(self.x_, self.y_,self.color_)
        ...
        local diamond_3 = Diamond.new(self.x_ + ConstDef.DIAMOND_SIZE.WIDTH, self.y_+ ConstDef.DIAMOND_SIZE.HEIGHT_, self.color_ )
...
function DiamondGroupYouSiJiao:rotateByClockwise()
...
function DiamondGroupYouSiJiao:rotateByAntclockwise()
