...
local DiamondGroupZuoSanJiao = class("DiamondGroupZuoSanJiao",require("src.app.data.Object"))
...
function DiamondGroupZuoSanJiao:ctor(x,y,color,size,state)
    DiamondGroupZuoSanJiao.super.ctor(self, x, y, color)
    self.state_ = state
    self:init(x, y, color, size)
end
...
function DiamondGroupZuoSanJiao :canRotateToSouth()
...
function DiamondGroupZuoSanJiao :canRotateToWest()
    local diamond_2 ={x = self.x_ - ConstDef.DIAMOND_SIZE.WIDTH*2, y = self.y_+ ConstDef.DIAMOND_SIZE.HEIGHT} 
...
function DiamondGroupZuoSanJiao :canRotateToNorth()
...
function DiamondGroupZuoSanJiao :canRotateToEast()
    local diamond_2 ={x = self.x_ + ConstDef.DIAMOND_SIZE.WIDTH, y = self.y_} 
...
function DiamondGroupZuoSanJiao:rotateByClockwise()
...
function DiamondGroupZuoSanJiao:rotateByAntclockwise()
...
function DiamondGroupZuoSanJiao:init()
    ...
    local diamond_4 = Diamond.new(self.x_, self.y+ ConstDef.DIAMOND_SIZE.HEIGHT_, self.color_)
    self.child_ = {diamond_1,diamond_2,diamond_3,diamond_4}
end

return DiamondGroupZuoSanJiao