...
local DiamondGroupTiXing = class("DiamondGroupTiXing",require("src.app.data.Object"))
...
function DiamondGroupTiXing:ctor(x,y,color)
    DiamondGroupTiXing.super.ctor(self, x, y, color)
    self.size_ = ConstDef.DIAMOND_GROUP_SIZE.TIXING
    self:init()
end
...
function DiamondGroupTiXing:canRotateToSouth()
    ...
    local diamond_4 ={x = self.x_ + ConstDef.DIAMOND_SIZE.WIDTH,y = self.y_ + ConstDef.DIAMOND_SIZE.HEIGHT} 
...
function DiamondGroupTiXing:init()
    local diamond_1 = Diamond.new(self.x_, self.y_, self.color_)
    local diamond_2 = Diamond.new(self.x_ - ConstDef.DIAMOND_SIZE.WIDTH, self.y_ + ConstDef.DIAMOND_SIZE.HEIGHT, self.color_)
    local diamond_3 = Diamond.new(self.x_, self.y_ + ConstDef.DIAMOND_SIZE.HEIGHT, self.color_)
    local diamond_4 = Diamond.new(self.x_, self.y_ + ConstDef.DIAMOND_SIZE.HEIGHT*2, self.color_)
...
function DiamondGroupTiXing:rotateByClockwise()
...
function DiamondGroupTiXing:rotateByAntclockwise()
