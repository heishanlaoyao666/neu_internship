...
function OppositeBossView:initView()
    ...
    --boss名字
    self.bossName=cc.Label:createWithTTF(ConstDef.BOSS[4].NAME,"ui/font/fzbiaozjw.ttf",34)
    ...
    --boss技能
    self.bossSkill=cc.Label:createWithTTF(ConstDef.BOSS[4].SKILL,"ui/font/fzbiaozjw.ttf",22)
