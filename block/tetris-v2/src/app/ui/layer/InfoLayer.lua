...
function InfoLayer:initView()
    ...
    self.scoreLabelTTF_ = display.newTTFLabel({
        text = tostring(GameData:getScore()),
        font = "Marker Felt",
        size = 30,
        color = cc.c3b(255, 255, 255)
    })
...
function InfoLayer:update(dt)
    self.scoreLabelTTF_:setString(tostring(GameData:getScore()))
    self.levelLabelTTF_:setString(tostring(GameData:getLevel()))
end
