...
function RegisterScene:onEnter()
    ...
    -- cc.size(350,100),"RegisterScene.png")--输入框尺寸﹐背景图片
    ...
    --editTxt :RegisterScenescriptEditBoxHandler(function(eventname, sender )
