...
function OverNode:init(itsColor)
    ...
    local nickname =
        ccui.Text:create(ConstantsUtil.username, ConstantsUtil.PATH_NORMAL_FONT_TTF, 30):addTo(nicknameField)
    ...
    local score =
        ...
        TypeConvert.Integer2StringLeadingZero(GameHandler.myRole.score, 3),
