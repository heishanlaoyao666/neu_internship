...
function GameScene:onEnter()
    ...
    --- 暂停
    self.pauseButton = tolua.cast(ccui.Helper:seekWidgetByName(gameScene, "pause"), "ccui.Button")
    ...
    --- 我方飞机相关
    local myRole = myRoleNode:create(ConstantsUtil.ROLE_PURPLE_PLANE):addTo(self, ConstantsUtil.LEVEL_VISIABLE_MEDIUM)
    local show = cc.MoveTo:create(2, cc.p(WinSize.width * 0.5, WinSize.height * 0.17))
    myRoleNode:runAction(show)
