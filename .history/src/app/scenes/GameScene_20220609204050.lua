        ...
        function(ref, event)
            ...
            elseif cc.EventCode.ENDED == event then
                ...
                if GameHandler.pause == false then
                    ...
                    GameHandler.PlaneData = clone(self.myRole)
                    --
...
-- 看了一下源代码 如果调用了Director的replaceScene 那么会先调用onExit 再调用cleanup 所以可以先在这里处理一下子弹、敌人和飞机
