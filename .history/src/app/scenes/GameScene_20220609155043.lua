...
function GameScene:onEnter()
    ...
    local function addBullet()
        ...
        local bullet = cc.Sprite:create(ConstantsUtil.PATH_BULLET_PNG):addTo(bulletNode)
    ...
    local function newEnemy()
        ...
        local enemyNode = cc.Node:create():addTo(self)
        local enemy = cc.Sprite:create(ConstantsUtil.PATH_SMALL_ENEMY_PNG):addTo(enemyNode)
        -- enemy:setScale(1.5)
