...
function Boss1:new(player,id,hp,sp,size)
    local boss1 = {}
    self.__index = self
    setmetatable(boss1,self)
    boss1:init(player,id,hp,sp,size)
    print(boss1)
    return boss1
end
...
function Boss1:init(player,id,hp,sp, size)
     --- 怪物基本信息
...
function Boss1:getHp()
    return self.hp_
end

function Boss1:getSp()
    return self.sp_
end

function Boss1:getSize()
    return self.size_
end
...
function Boss1:destroy()
    self.player_:removeBoss()
end
