...
function FightingBGLayer:initView()
    ...
    local bgSprite1 = display.newSprite("artcontent/battle(ongame)/battle_interface/basemap_bottom.png")
    ...
    local bgSprite2 = display.newSprite("artcontent/battle(ongame)/battle_interface/basemap_top.png")
