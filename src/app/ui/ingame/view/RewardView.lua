...
function RewardView:initView()
    --底图
    local spriteRes = "artcontent/lobby(ongame)/currency/chestopen_ obtainitemspopup/basemap_popup.png"
    ...
    --基础奖励图标
    local basicRewardSprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/icon_basicreward.png")
    basicRewardSprite:setPosition(display.cx - 200, display.cy - 50)
    basicRewardSprite:addTo(self)

    --连胜奖励图标
    spriteRes = "artcontent/battle(ongame)/settlement_interface/icon_winningstreakaward.png"
    ...
    --buff奖励
    local buffReward = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/icon_buffreward.png")
    ...
    for i = 1, 3 do
        --奖励底图
        local rewardSprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/basemap_reward.png")
        rewardSprite:setPosition(display.cx + 50, index_y)
        rewardSprite:addTo(self)

        --奖杯
        local trophySprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/icon_trophy.png")
        ...
        --金币
        local goldSprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/icon_gold.png")
    ...
    --钻石
    local diamondSprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/icon_diamond.png")
    ...
    --总计底图
    local totalSprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/basemap_tatalawards.png")
    ...
    --奖杯
    trophySprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/icon_trophy.png")
    ...
    --金币
    goldSprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/icon_gold.png")
    ...
    --钻石
    diamondSprite = cc.Sprite:create("artcontent/battle(ongame)/settlement_interface/icon_diamond.png")
