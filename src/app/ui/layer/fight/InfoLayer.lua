...
function InfoLayer:ctor()
    ...
    self.emenyCardGroup_ = {} -- 类型 card数组 敌方卡组
    ...
    self.enemyLevlSprite_ = nil --对方段位
    self.levlSprite_ = nil --己方段位
...
function InfoLayer:init()
    ...
    self.emenyCardGroup_ = {card1,card1,card1,card1,card1}
...
function InfoLayer:initView()
    --敌方crad图片尺寸120*120
    --敌方card设计尺寸 60*60
    --敌方card的levl图片尺寸36*20
    --敌方card的levl设计尺寸36*20
    --敌方card的角标图片尺寸34*42
    --敌方card的角标设计尺寸17*21
    ...
    for i =1,#self.emenyCardGroup_ do
        --敌方卡片的图片
        local sprite = display.newSprite(self.emenyCardGroup_[i]:getSmallSpriteImg())
        ...
        --敌方卡片的等级
        local sprite1 = display.newSprite(self.emenyCardGroup_[i]:getLevelImg())
        ...
        --敌方卡片的攻击类型
        local sprite2 = display.newSprite(self.emenyCardGroup_[i]:getTypeImg())
    ...
    self.enemyLevlSprite_ = enemyLevel
    ...
    --己方crad图片尺寸120*120
    --己方card设计尺寸 90*90
    --己方card的levl图片尺寸36*20
    --己方card的levl设计尺寸54*30
    --己方card的角标图片尺寸34*42
    ...
    for i =1,#self.cardGroup_ do
        --己方卡片的图片
        local sprite = display.newSprite(self.cardGroup_[i]:getSmallSpriteImg())
