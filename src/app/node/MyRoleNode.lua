...
function MyRoleNode:init(painting, duration, targetX, targetY)
    ...
    Log.i(tostring(self.myRole:getContentSize().height))
    Log.i(tostring(self.tailFlame:getContentSize().height))
    Log.i(tostring(ConstantsUtil.DEFAULT_DELTA_HEIGHT))
    ...
    self.tailFlame:setPosition(WinSize.width / 2, WinSize.height * -0.3 - ConstantsUtil.DEFAULT_DELTA_HEIGHT)
